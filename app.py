...
<div class="hero-section">
    ...
    <div class="hero-desc">
        Welcome to my personalized AI Chatbot project. 
        Powered by advanced Llama 3.3 70B model, this AI can answer any question 
        with intelligence, accuracy, and a touch of personality.
    </div>
